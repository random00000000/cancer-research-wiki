# Source Card: LNP And mRNA Cancer Vaccine Delivery Reviews
...
- mRNA needs a delivery system because naked mRNA is fragile and does not automatically reach the right immune cells.
...
- Delivery is part of the therapy, not packaging decoration.
- LNP or lipoplex success in infectious-disease vaccines does not automatically prove success for cancer vaccines.
- Dendritic-cell access, antigen presentation, innate immune activation, and tolerability are central design constraints.

## Claims Requiring Caution

- Many delivery improvements are preclinical.
- Cell-targeting claims often depend on animal models, route of administration, dose, chemistry, and assay choice.
- Do not translate formulation literature into DIY LNP manufacturing instructions.

## Follow-Up Crawl Targets

- Comparative human data for LNP versus lipoplex platforms.
