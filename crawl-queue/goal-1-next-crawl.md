...
- Visually QA the circadian/sleep/light-at-night visual and first localized variants: `visuals/circadian-sleep-light-cancer-risk.svg`, `.es.svg`, `.de.svg`, `.zh.svg`, and `.ru.svg`. Then QA the night-shift worker-protection and drowsy-driving visual sets and deepen occupation-specific scheduling, light-at-night, worker protection, and sleep-disorder support evidence before expanding to additional languages.
