...
- Deepen metabolic health, movement, and food-pattern evidence beyond public agency summaries. Started: `prevention/metabolic-health-diet-activity-evidence.md` plus localized public visual variants. Added focused body-fatness cancer-site evidence, colorectal food-pattern evidence, ultra-processed-food evidence, and localized visual variants. Next: site-specific body-fatness effect sizes, colorectal absolute-risk examples, UPF subgroup evidence, additive-specific evidence, and intervention evidence.
- Deepen circadian disruption, sleep, night shift, and light-at-night evidence. Started: `prevention/circadian-sleep-light-cancer-evidence.md` plus localized public visual variants. Occupational systems follow-up started: `prevention/night-shift-work-systems-cancer-prevention.md` and `visuals/night-shift-worker-protection-cancer.svg`. Commute safety follow-up started: `prevention/night-shift-drowsy-driving-injury-safety.md` and `visuals/night-shift-drowsy-driving-safety.svg`. Sleep-disorder support follow-up started: `prevention/night-shift-sleep-disorder-clinical-support.md` and `visuals/night-shift-sleep-disorder-support.svg`. Next: occupation-specific implementation, newer transport-injury reviews, medication/timing evidence, cancer-type-specific source cards, and equity notes for night workers and caregivers.
...
- Deepen radon evidence beyond public agency summaries. Started: `prevention/radon-home-lung-cancer-evidence.md` plus localized public visual variants. Next: radon-resistant construction evidence, mitigation financing, tenant/landlord policy, schools/workplaces, and country-specific action levels.
- Deepen air pollution and PM2.5 lung cancer evidence beyond public agency summaries. Started: `prevention/air-pollution-lung-cancer-evidence.md` plus localized public visual variants. Next: PM2.5 source attribution, wildfire smoke, traffic-related air pollution, indoor biomass, filtration policy, and environmental justice.
...
- Visually QA the air pollution lung cancer prevention visual and first localized variants: `visuals/air-pollution-lung-cancer-prevention.svg`, `.es.svg`, `.de.svg`, `.zh.svg`, and `.ru.svg`. Then deepen PM2.5 source, wildfire, traffic, filtration, and environmental-justice evidence before expanding to additional languages.
...
- Visually QA the body-fatness/metabolic cancer-site visual and first localized variants: `visuals/body-fatness-metabolic-cancer-sites.svg`, `.es.svg`, `.de.svg`, `.zh.svg`, and `.ru.svg`. Then deepen site-specific effect sizes, early-life body-size evidence, and intervention evidence before expanding to additional languages.
- Visually QA the circadian/sleep/light-at-night visual and first localized variants: `visuals/circadian-sleep-light-cancer-risk.svg`, `.es.svg`, `.de.svg`, `.zh.svg`, and `.ru.svg`. Then QA the night-shift worker-protection, drowsy-driving, and sleep-disorder support visual sets and deepen occupation-specific scheduling, light-at-night, worker protection, medication/timing, and sleep-health access evidence before expanding to additional languages.
- Visually QA the colorectal food-pattern visual and first localized variants: `visuals/colorectal-food-pattern-prevention.svg`, `.es.svg`, `.de.svg`, `.zh.svg`, and `.ru.svg`. Then deepen absolute-risk examples, affordable fiber-rich foods by region, and processed-meat wording before expanding to additional languages.
- Visually QA the ultra-processed-food visual and first localized variants: `visuals/ultra-processed-foods-cancer-risk.svg`, `.es.svg`, `.de.svg`, `.zh.svg`, and `.ru.svg`. Then deepen UPF subgroup evidence, additive-specific evidence, and affordable swap examples before expanding to additional languages.
