...
- Deepen metabolic health, movement, and food-pattern evidence beyond public agency summaries. Started: `prevention/metabolic-health-diet-activity-evidence.md` plus localized public visual variants. Added focused colorectal food-pattern evidence, ultra-processed-food evidence, and localized visual variants. Next: colorectal absolute-risk examples, UPF subgroup evidence, additive-specific evidence, and body-weight cancer-site map.
