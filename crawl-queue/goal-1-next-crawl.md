...
- Deepen circadian disruption, sleep, night shift, and light-at-night evidence. Started: `prevention/circadian-sleep-light-cancer-evidence.md` plus localized public visual variants. Occupational systems follow-up started: `prevention/night-shift-work-systems-cancer-prevention.md` and `visuals/night-shift-worker-protection-cancer.svg`. Next: occupation-specific implementation, drowsy driving, cancer-type-specific source cards, and equity notes for night workers and caregivers.
