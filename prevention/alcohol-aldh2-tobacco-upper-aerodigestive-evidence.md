...
```mermaid
flowchart LR
    A["Alcohol intake"] --> B["Ethanol"]
    B --> C["Acetaldehyde"]
    C --> D["DNA adducts and repair stress"]
    C --> E["Squamous tissue exposure"]
    F["Low-activity ALDH2 variant"] --> G["Slower acetaldehyde clearance"]
    G --> C
    H["Tobacco smoke"] --> I["Additional carcinogens"]
    I --> D
    C --> J["Higher upper-aerodigestive cancer risk"]
    I --> J
```
